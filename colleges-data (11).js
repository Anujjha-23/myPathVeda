...
const collegesData = [
  ...
  /* ───────── MBA ───────── */
  {
    ...
    logo: "https://logo.clearbit.com/amityonline.com", logoText: "AU", color: "#0A2463",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/nmimsglobalaccess.in", logoText: "NM", color: "#1a237e",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/onlinemanipal.com", logoText: "MU", color: "#bf360c",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/jainuniversity.ac.in", logoText: "JU", color: "#2e7d32",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/lpu.in", logoText: "LPU", color: "#6a1b9a",
    name: "LPU Online",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/cuchd.in", logoText: "CU", color: "#00695c",
    ...
    students: "35,000+",
    description: "Chandigarh University is both QS World Ranked and NAAC A+ accredited — making it one of the most globally credible online MBA providers in India. Strong placement ties with North India's manufacturing, IT, and services sectors.",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/scdl.net", logoText: "SY", color: "#b71c1c",
    name: "Symbiosis SCDL",
    ...
    students: "20,000+",
    description: "Symbiosis Centre for Distance Learning (SCDL) is one of India's oldest and most respected distance/online education providers. Research-driven with case-method learning, strong corporate faculty, and deep alumni roots in FMCG, consulting, and financial services.",
  ...
  {
    id: 8, slug: "ignou-mba",
    logo: "https://logo.clearbit.com/ignou.ac.in", logoText: "IGN", color: "#37474f",
    name: "IGNOU",
    ...
    students: "3,00,000+",
    description: "IGNOU is a Central Government institution and the world's largest open university. Its MBA offers maximum flexibility (2 to 5 years), the lowest fees in India, and is the top choice for government employees, defense personnel, and students in remote areas.",
  ...
  /* ───────── BBA ───────── */
  {
    ...
    logo: "https://logo.clearbit.com/vignanonline.com", logoText: "VU", color: "#1565c0",
    name: "Vignan Online",
    ...
    students: "18,000+",
    description: "Vignan University Online offers one of the most affordable UGC-approved BBA programs in India. Designed for Class 12 graduates who want a recognized business foundation degree with flexibility to work or prepare for further studies simultaneously.",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/lpu.in", logoText: "LBB", color: "#4527a0",
    name: "LPU Online BBA",
    ...
    ranking: "NAAC A++ — Highest Grade",
    students: "22,000+",
    description: "LPU's online BBA is backed by its NAAC A++ accreditation and 700+ corporate partner network. An ideal entry-level business degree for fresh Class 12 students looking for a recognized, affordable, and placement-focused undergraduate business program.",
  ...
  /* ───────── BCA ───────── */
  {
    ...
    logo: "https://logo.clearbit.com/onlinemanipal.com", logoText: "MBC", color: "#4a148c",
    ...
    students: "22,000+",
    description: "Manipal Online BCA combines the Manipal University brand with a hands-on, industry-aligned computer science curriculum. IT companies actively recruit Manipal BCA graduates into entry-level developer, QA, and data roles.",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/amityonline.com", logoText: "ABC", color: "#0A2463",
  ...
  /* ───────── MCA ───────── */
  {
    ...
    logo: "https://logo.clearbit.com/lpu.in", logoText: "LMC", color: "#004d40",
    name: "LPU Online MCA",
    ...
    students: "28,000+",
    description: "LPU's online MCA is designed for BCA/BSc graduates who want to move into software engineering, data science, or IT management. NAAC A++ quality with advanced specializations in AI, ML, and Cloud.",
  ...
  },
  {
    ...
    logo: "https://logo.clearbit.com/onlinemanipal.com", logoText: "MMC", color: "#bf360c",
    ...
    students: "15,000+",
    description: "Manipal Online MCA builds deep technical expertise in software development, cloud, and emerging tech. The Manipal brand is well-recognized by IT recruiters across Bengaluru, Hyderabad, and Pune tech hubs.",
